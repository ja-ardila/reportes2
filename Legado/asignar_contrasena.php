...
// Verificar si el token existe en la base de datos (GET)
if (!empty($token)) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($nueva_contrasena) < 6) {
        ...
        if ($resultado->num_rows > 0) {
            ...
            if ($update->execute()) {
                $mensaje = "Tu contraseña ha sido creada exitosamente. Ahora puedes <a href='login.php'>iniciar sesión</a>.";
                $token_valido = false;
            } else {
...
<body>
    <div class="formulario">
        ...
        <?php else: ?>
            <p class="mensaje">Token no válido o ya fue utilizado.</p>
        <?php endif; ?>
    </div>
